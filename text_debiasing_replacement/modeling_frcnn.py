...
def norm_box(boxes, raw_sizes):
    ...
    for i in range(len(normalized_boxes[0])):
        normalized_boxes[:, i, 0] /= raw_sizes[:, 1]
        normalized_boxes[:, i, 2] /= raw_sizes[:, 1]
        normalized_boxes[:, i, 1] /= raw_sizes[:, 0]
        normalized_boxes[:, i, 3] /= raw_sizes[:, 0]
